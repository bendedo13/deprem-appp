...
export default function AdminLayout() {
    ...
    const navItems = [
        ...
        { icon: <AlertTriangle size={20} />, label: 'SOS Kayıtları', path: '/admin/sos' },
        ...
        <div className="min-h-screen bg-dark flex">
            ...
            <aside className="hidden lg:flex flex-col w-64 bg-dark-surface border-r border-dark-border">
                ...
                <div className="p-4 border-t border-dark-border">
                    <div className="mb-3 px-4 py-2 rounded-xl bg-dark/50">
                        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Giriş Yapılan Hesap</p>
            ...
            {isSidebarOpen && (
                ...
                >
                    <aside
                        className="w-72 h-full bg-dark-surface border-r border-dark-border p-6 flex flex-col"
